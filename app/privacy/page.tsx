...
export default function PrivacyPolicyPage() {
  return (
    <main className="py-12">
      <Container>
        <Pill>Legal</Pill>
        <h1 className="mt-4 font-display text-3xl tracking-tight text-ink-950 dark:text-ink-50 sm:text-4xl">Privacy Policy</h1>
        <p className="mt-3 max-w-3xl text-ink-800 dark:text-ink-200">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-ink-800 dark:text-ink-200">
          <section>
            <h2 className="text-base font-semibold text-ink-950 dark:text-ink-50">Information we collect</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-ink-950 dark:text-ink-50">How we use information</h2>
            <ul className="mt-2 list-disc space-y-2 pl-5">
          ...
          <section>
            <h2 className="text-base font-semibold text-ink-950 dark:text-ink-50">Legal bases (where required)</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-ink-950 dark:text-ink-50">Third-party services</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-ink-950 dark:text-ink-50">Data sharing</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-ink-950 dark:text-ink-50">Data retention</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-ink-950 dark:text-ink-50">Your rights</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-ink-950 dark:text-ink-50">Children&apos;s privacy</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-ink-950 dark:text-ink-50">Security</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-ink-950 dark:text-ink-50">Policy updates</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-base font-semibold text-ink-950 dark:text-ink-50">Important legal note</h2>
            <p className="mt-2">

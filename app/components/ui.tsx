...
export function Button({
  ...
  const base =
    "touch-target inline-flex items-center justify-center rounded-xl px-4 py-2.5 text-sm font-semibold transition focus:outline-none focus-visible:ring-2 focus-visible:ring-ink-500 focus-visible:ring-offset-2";
  const styles =
    kind === "primary"

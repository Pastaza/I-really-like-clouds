...
export default function GuidePage() {
  return (
    <main className="py-12">
      <Container>
        <Pill>Guide</Pill>
        <h1 className="mt-4 font-display text-3xl tracking-tight text-ink-950 dark:text-ink-50 sm:text-4xl">
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2">
          <Card>
            ...
            <ul className="mt-4 grid list-disc gap-x-8 gap-y-2 pl-5 text-sm text-ink-700 dark:text-ink-200 sm:grid-cols-2">
              <li>Cirrus (Ci)</li>
          ...
          <Card>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-ink-700 dark:text-ink-200">
              <li>
          ...
          <Card>
            ...
            <div className="mt-4 rounded-xl bg-white/70 p-4 text-sm text-ink-800 ring-1 ring-ink-900/10 dark:bg-white/10 dark:text-ink-200 dark:ring-white/10">
        ...
        <div className="mt-10">
          <Link className="touch-target inline-flex items-center text-sm font-semibold text-ink-900 hover:text-ink-700 dark:text-ink-200 dark:hover:text-ink-50" href="/atlas">
